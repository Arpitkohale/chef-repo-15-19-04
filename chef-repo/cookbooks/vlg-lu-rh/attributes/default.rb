...
# enable ssl in non-vagrant environments
unless Chef::Config[:solo]
  ...
  default['vlg-tomcat']['port_8444']['ssl_ca_certificate_file'] = '/etc/pki/CA/certs/gdig2_bundle.crt'
end
...
# cron
unless Chef::Config[:solo]
default['vlg-cron']['jobs']['lu-rh-log-pusher'] = {
  'time' => '*/10 * * * *',
...
default['vlg-cron']['jobs']['lu-rh-tomcat-archiver'] = {
  'time' => '*/10 * * * *',
  'user' => "#{node['vlg-base']['app_user']}",
