...
# couchbase
default['vlg-lz-cb']['data_dir'] = "/data"

force_default['couchbase']['server']['package_file'] = "couchbase-server-community-3.0.1-centos6.x86_64.rpm"
force_default['couchbase']['server']['package_full_url'] = "http://s3.amazonaws.com/videologypublic/repo/couchbase-server-community-3.0.1-centos6.x86_64.rpm"

data = Chef::EncryptedDataBagItem.load("lz", "cb")
lz_cb_password = data["password"]
force_default['couchbase']['server']['password'] = "#{lz_cb_password}"
