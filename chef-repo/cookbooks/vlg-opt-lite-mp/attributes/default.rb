...
# URIs
default['vlg-opt-lite-mp']['ol1']['req']['guaranteedURIs'] = "tcp://optlite-az.tidaltv.com:6001/"
default['vlg-opt-lite-mp']['ol1']['req']['dcpmURIs'] = "tcp://optlite-az.tidaltv.com:6004/"
default['vlg-opt-lite-mp']['ol1']['req']['reservedURIs'] = "tcp://optlite-az.tidaltv.com:6005/"
default['vlg-opt-lite-mp']['ol1']['req']['cancelledURIs'] = "tcp://optlite-az.tidaltv.com:6006/"
default['vlg-opt-lite-mp']['mp_request_version'] = "1.0"
...
case node.chef_environment
when "production"
default['vlg-cron']['jobs']['MP_cleanup_job'] = {
  'time' => '0 * * * *',
  'user' => "#{node['vlg-base']['app_user']}",
  'command' => "find #{node["vlg-clicksense"]["local_dir"]}/cache -mindepth 2 -maxdepth 3 -type f -mtime +5 -exec rm -rfv {} \\; >> #{node['vlg-base']['log_dir']}/mp_cleanup_job/mp_cleanup.`date +\\%Y-\\%m-\\%d`.log 2>&1",
}
end
