...
# Gurobi and GAMS
default['vlg-opt-lp-common']['install_dir'] = '/usr/local'
default['vlg-opt-lp-common']['gurobi_home'] = "/usr/local/gurobi"
default['vlg-opt-lp-common']['gams_home'] = "/usr/local/gams"
