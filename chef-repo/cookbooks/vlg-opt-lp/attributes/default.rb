...
default['vlg-tomcat']['jvm_heap'] = '7g'
default['vlg-tomcat']['jvm_heap_mx'] = '14g'

default['vlg-tomcat']['app_deployment'] = "opt"

# URIs
default['vlg-opt-lp']['ol1']['req']['guaranteedURIs'] = "tcp://optlite-az.tidaltv.com:6001/"
default['vlg-opt-lp']['ol1']['req']['dcpmURIs'] = "tcp://optlite-az.tidaltv.com:6004/"
default['vlg-opt-lp']['ol1']['req']['reservedURIs'] = "tcp://optlite-az.tidaltv.com:6005/"
default['vlg-opt-lp']['ol1']['req']['cancelledURIs'] = "tcp://optlite-az.tidaltv.com:6006/"
default['vlg-opt-lp']['lp_request_version'] = "1.0"
...
when "production"
  force_override['vlg-swap']['size'] = 30720
when "sandbox"
  force_override['vlg-swap']['size'] = 61440
end
